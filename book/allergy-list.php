				...
				<div class="sixteen columns">
					...
					<div class="cf">
						<div class="fleft" id="prevCh">
							<p class="pagination prev_ch"><a href="./medication-reconciliation.php">Go back to Medication Reconciliation</a></p></div>
						<div class="fright" id="nextCh">
							<p class="pagination next_ch"><a href="./eprescribing.php">Continue to ePrescribing</a></p></div>
					</div>
				</div>
			</div>
		</footer>
