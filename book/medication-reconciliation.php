				...
				<div class="sixteen columns">
					...
					<div class="example" id="gal-3-1">
						...
						<div id="cbp-fwslider" class="scale-with-grid cbp-fwslider">
							<ul>
								<li><div>
									<div class="caption"><span class="ex-type">3.1a</span> The two lists side by side before Twinlist starts matching similar drugs</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.1b</span> The identical drugs have now moved to the center, while the unique drugs have moved to their respective sides. Similar drugs (e.g. Aricept and donepezil) have aligned below these, while the differences between the similar drugs highlighted in yellow.</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.1c</span> When the pointer hovers over a drug (here Amaryl), that drug is highlighted with a dark background. Similar drugs are also highlighted (here glimepiride). Additional details of the drug appear at the bottom of the screen</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.1e</span> The final reconciled medication list can be reviewed by looking at all the <a href="./design-principles.php#dark-side-of-color">bright green</a><span class="print-only"> (See The Dark Side of Color in the Design Principles chapter)</span> selected drugs, and it’s clear what lists they’ve come from.</div>
				...
				<div class="sixteen columns">
					...
					<div class="example" id="gal-3-2">
						...
						<div id="cbp-fwslider-2" class="scale-with-grid cbp-fwslider">
							<ul>
								<li><div>
									<div class="caption"><span class="ex-type">3.2a</span> The interface presents each drug in the patient’s medication list, one at a time. The system offers a few clearly-marked choices. The mode of presentation is well suited to a touch interface. A progress bar indicates how many drugs are in the list (and can help users get into a <a href="./human-factors.php#flow-state">flow state</a>.)<span class="print-only"> (See Go with the Flow in the Human Factors chapter)</span></div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.2b</span> The patient may not be taking a drug for various reasons: a physician countermanded that order, the patient did not tolerated the medication, never filled the prescription, etc.</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.2d</span> The patient may be unsure about a particular medication. She may not recognize the medication name, may be unsure about the exact dose, or may be unsure about something else.</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.2e</span> Once the patient’s reviewed all the medications in the list the EHR had on file for her, the prompt reminds her to add missing prescriptions. It also prompts her to add any other items she might be taking, but which are often forgotten – such as eye drops, over-the-counter medications, vitamins and herbal preparations, etc.   The interface allows for fuzzy misspelling and suggests appropriate possible names as the patient begins to type.</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.2f</span> Final review: The patient can review the entire list, and can add comments and mark the medications she needs the physician to renew.</div>
					...
					<div class="example" id="gal-3-3">
						...
						<div id="cbp-fwslider-3" class="scale-with-grid cbp-fwslider">
							<ul>
								<li><div>
									<div class="caption"><span class="ex-type">3.3a</span> The list is now sorted according to the answers provided during the review. Actionable items are grouped together: new medications will probably need to be added, medications the patient reports not taking may need to be adjusted or removed, medications the patient is unsure about will have to be discussed, etc. The red and green bars on the left side show whether the patient is “taking” or “not taking” the specific medications.</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.3b</span> The physician can clarify the details during a conversation with the patient, and then edits the comments.</div>
								...
								<li><div>
									<div class="caption"><span class="ex-type">3.3d</span> The physician has the option to confirm the status of all or some of the medications.</div>
