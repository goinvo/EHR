		...
		<section id="simple-list" class="section">
			<div class="container">
				<div class="sixteen columns">
					...
					<p>Use just enough difference to make it immediately apparent. If the difference in type is too great, it can be visually jarring. If the difference is too subtle, then it won’t be perceived by the <a href="./human-factors.html#how-people-perceive" target="blank">visual processing system</a> of the human brain. The features that the visual system detects readily are called “<a href="./human-factors.html#preattentive-attributes" target="blank">preattentive attributes</a>.”</p>
				</div>				
				...
				<div class="sixteen columns">
					<div class="quicktip">
						...
						<div class="qt-content show">
							...
							<p><a href="./human-factors.html#preattentive-attributes" target="blank">Read more in the chapter on Human Factors Principles.</a></p>
						</div>
					</div>
				</div>
				<div class="sixteen columns">
					...
					<p>Reduce visual noise If a visual element doesn’t add data, or improve the perception or processing of information, then try leaving it out. See <a href="#gal-2-1">Gallery 2.1</a></p>
					
				<!--Gal 2-1 Reduce Noise-->
					<div class="example" id="gal-2-1">
						<div class="ex-title">
							<span class="ex-type">Gallery 2.1</span>
							<span class="ex-caption">Needs Improvement</span>
						</div>
						<div id="cbp-fwslider" class="scale-with-grid cbp-fwslider">
							<ul>
								<li><div>
									...
									<div class="caption">Needs Improvement</div>
								</div></li>
								<li><div>
									<a href="./assets/images/examples/medication-list/SimpleList_ReduceNoise.png" class="fancybox"  data-fancybox-group="gallery"><img src="./assets/images/examples/medication-list/SimpleList_ReduceNoise.png" class="scale-with-grid" alt="Reduce Noise" /></a>
									<div class="caption">We removed the grid to make it less visually noisy. Borders don’t add information.</div>
								</div></li>
							</ul>
						</div>
					</div>
				...
				<div class="sixteen columns">
					...
					<div class="example" id="int-2-1">
						<div class="ex-title">
							...
							<span class="ex-caption"><a href="../interactive-table/interactive-table.html" target="blank">Medication List Prototype – Go play!</a></span>
						</div>
					...
					<div class="example" id="fig-2-2">
						<div class="ex-title">
							<span class="ex-type">Figure 2.2</span>
							<span class="ex-caption">Physician's mental work (<a href="./human-factors.html#cognitive-load"  target="blank"> cognitive load</a>) adjusting BP meds</span>
						</div>
					...
					<p>You can reduce the risk of error (missing one in the list) and lighten the mental effort (<a href="./human-factors.html#cognitive-load" target="blank">cognitive load</a>) quite a bit with the use of smart design features.</p>
					<p>In order of complexity, here are some solutions:</p>
					<p>Follow <a href="https://sbmi.uth.edu/dotAsset/3fc9f186-7608-4b57-9ade-64a90e5916e0.pdf" target="blank">Effective Table Design guidelines</a>. For example, make sure headers remain visible all the time and don’t scroll out of view. The most important columns should be on the left (drug names in this case). Make sure long names (like compound drugs) don’t get truncated without leaving some visual indication, and make the entire name quickly accessible. You can read more at the <a href="https://sbmi.uth.edu/dotAsset/3fc9f186-7608-4b57-9ade-64a90e5916e0.pdf" target="blank">SHARP-C website</a>.</p>
				...
				<div class="sixteen columns">
					<div class="quicktip">
						...
						<div class="qt-content show">
							...
							<p><a href="./human-factors.html#working-memory" target="blank">Read more in chapter on Human Factors Principles.</a></p>
						</div>
					</div>
				</div>
				<div class="sixteen columns">
					...
					<p>Here’s the prototype. <a href="../interactive-table/interactive-table.html" target="blank">Medication List - Table View - Prototype</a>
		...
		<section id="timeline" class="section">
			<div class="container">
				<div class="sixteen columns">
					...
					<h5>Here’s a prototype timeline. Go play.</h5>
					<p>We’ve made an interactive prototype for you to play with. Imagine a few clinical tasks to accomplish while playing with it. We listed a few below. Compare this prototype to the tools in your existing EHR to see the difference in user experience. You might want to time yourself, or time a friend or colleague doing the same task. Is one tool more accurate for you?</p>
					<p>Here’s the prototype. <a href="http://localhost/ehr/timeline/timeline.html" target="blank">Medication Timeline - Prototype</a>
					<br />For this prototype, assume “today” is Sep 18, 2013.</p>
					...
					<div class="example" id="int-2-2">
						<div class="ex-title">
							...
							<span class="ex-caption"><a href="../timeline/timeline.html" title="Active medications in the timeline" target="blank">Medication Timeline Prototype – Go play!</a></span>
						</div>
					...
					<p>Summary</p>
						<ol>
							...
							<li><p>Use <a href="./human-factors.html#preattentive-attributes" target="blank">preattentive attributes</a> (like color, size, shape, alignment) to draw the user’s attention to the salient details. </p></li>
							...
							<li>Remember that humans have very limited <a href="./human-factors.html#working-memory" target="blank">working memory</a> (only 3 to 4 items), so put information directly in view where possible. Eliminate the need to remember details from one step to the next in a task sequence.</li>
							...
							<li>Reduce <a href="./human-factors.html#cognitive-load" target="blank">cognitive load</a>. Do the math for the user. Design so that repetitive reading is not required. Present the information directly instead of requiring the user to recall it.</li>
				...
				<div class="sixteen columns">
					...
					<div class="cf">
						<div class="fleft" id="prevCh">
							<p class="pagination prev_ch"><a href="./about-this-book.php">Go back to About this Book</a></p></div>
						<div class="fright" id="nextCh">
							<p class="pagination next_ch"><a href="./medication-reconciliation.php">Continue to Medication Reconciliation</a></p></div>
					</div>
				</div>
			</div>
		</footer>
